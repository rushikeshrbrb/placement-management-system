...
import { getHodByUserId, updateHod } from "../../Services/services";



export function UpdateHod() {
...
const [formData, setFormData] = useState({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await updateHod(userId, formData);
      console.log(result);
      setTimeout(() => {
  ...
  const populateadminState = async () => {
    try {
      ...
      const result = await getHodByUserId(userId);

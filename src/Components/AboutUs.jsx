        ...
        <Container fluid>
            ...
            <Row className="justify-content-md-center">
                <Col  md={8}>
                        <Card style={{width:"800px"}} >
                            <Card.Body>
                                <Card.Title style={{ color: 'black', fontWeight: 'bold', textAlign: 'center' }}>Purpose of the Training & Placement Cell</Card.Title>
            ...
            <Row>
                <Col lg={4}>
                    <Card>
                        <Card.Body>
                            <Card.Title style={{ color: 'black', fontWeight: 'bold' }}>Vision</Card.Title>
                ...
                <Col lg={4}>
                    <Card>
                        <Card.Body>
                            <Card.Title style={{ color: 'black', fontWeight: 'bold' }}>Mission</Card.Title>
                            <Card.Text style={{ color: 'black', fontStyle: 'italic' }}>
                ...
                <Col lg={4}>
                    <Card>
                        <Card.Body>
                            <Card.Title style={{ color: 'black', fontWeight: 'bold' }}>Our Objective</Card.Title>
                            <Card.Text style={{ color: 'black', fontStyle: 'italic' }}>
            ...
            <center>
                ...
                <Row className="mx-5" >
                    ...
                    <Col lg={4} style={{ textAlign: "center" }}>
                        ...
                        <Card style={{ width: '20rem', transition: 'transform 0.3s', ':hover': { transform: 'scale(1.05)' } }}>
                    ...
                    <Col lg={4} style={{ textAlign: "center" }}>
                        <Card style={{ width: '20rem' }}>
                            ...
                            <Card.Body>
                                ...
                                <Button variant="info"><a href="https://www.linkedin.com/in/anisha-vanjari-b875a4244/">LinkedIn</a></Button>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col lg={4} style={{ textAlign: "center" }}>
